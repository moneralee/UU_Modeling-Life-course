...
The code was refactored to be more modular and was extended with a basic graphical user interface for real-time visualization using Matplotlib.
...
- The subfolder "GUI" contains a Matplotlib-based visualization.